...
public class TsFileManager {
  ...
  public List<TsFileResource> getCopyOfSequenceListByTimePartition(long timePartition) {
    readLock();
    try {
      return sequenceFiles.getOrDefault(timePartition, new TsFileResourceList()).getArrayList();
    } finally {
      readUnlock();
    }
  }
